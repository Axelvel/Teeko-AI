...
@param int $x,y - the coordinates of the wanted position of the pawns
@param bool $cflag - allow console messages
@return bool - ??
"""
...
"""
@desc Main function that launchs the game
@param State $state - the initial state of the game
"""
def play(state):
    print("Lauching game...\n")
